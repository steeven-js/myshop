                                    ...
                                    <tr class="cart_table_item">
                                        <td class="product-thumbnail">
                                            <div class="product-thumbnail-wrapper">
                                                <a href="{{ route('cart.delete', $itemCart->product->id) }}"
                                        ...
                                        <td class="product-price">
                                            <span
                                                class="amount font-weight-medium text-color-grey">{{ $itemCart->prix }}€</span>
                                        </td>
                                        <td class="product-quantity">
                                            <div class="quantity float-none m-0">
                                                <a href="{{ route('decrementCartItem', $itemCart->product) }}"><input
                                                        type="button"
                                                ...
                                                <input type="text" class="input-text qty text" title="Qty"
                                                    value="{{ $itemCart->quantity }}" name="quantity" min="1"
                                                    step="1">
                                                <a href="{{ route('incrementCartItem', $itemCart->product) }}"><input
                                                        type="button"
                                        ...
                                        <td class="product-subtotal text-end">
                                            <span
                                                class="amount text-color-dark font-weight-bold text-4">{{ $itemCart->quantity * $itemCart->prix }}€</span>
                                        </td>
                                    </tr>
                                @endforeach
                    @endif
                            ...
                            <div class="row justify-content-between mx-0">
                                ...
                                <div class="col-md-auto px-0">
                                    <a href="{{ route('cart.destroy') }}"
                                        class="btn btn-light btn-modern text-color-dark bg-color-light-scale-2 text-color-hover-light bg-color-hover-primary text-uppercase text-3 font-weight-bold border-0 border-radius-0 btn-px-4 py-3">Vider
                                        le panier</a>
                                </div>
                            </div>
                        </td>
            ...
            <div class="card border-width-3 border-radius-0 border-color-hover-dark" data-plugin-sticky
                ...
                <div class="card-body">
                            ...
                            <tr class="total">
                                ...
                                <td class="text-end">
                                    <strong class="text-color-dark"><span
                                            class="amount text-color-dark text-5">{{ $somme }}€</span></strong>
                                </td>
                            </tr>
                    ...
                    @if ($carts->isEmpty())
                        @guest
                            <a href="{{ route('login') }}"
                                class="btn btn-dark btn-modern w-100 text-uppercase bg-color-hover-primary border-color-hover-primary border-radius-0 text-3 py-3">Connectez-vous
                                pour continuer</a>
                        @else
                            <p>Le panier est vide.</p>
                        @endif
